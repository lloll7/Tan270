...
function updateSlides() {
  ...
  if (params.centeredSlides && params.cssMode) {
    uni_modules_zebraSwiper_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-before", "");
    uni_modules_zebraSwiper_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-after", "");
  }
  ...
  if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
    uni_modules_zebraSwiper_shared_utils.setCSSProperty(swiper.wrapperEl, "--swiper-centered-offset-before", `${-snapGrid[0]}px`);
    uni_modules_zebraSwiper_shared_utils.setCSSProperty(
      swiper.wrapperEl,
