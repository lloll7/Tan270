"use strict";
const uni_modules_zebraSwiper_shared_classesToSelector = require("../../shared/classes-to-selector.js");
function Pagination({
  swiper,
  extendParams,
  on,
  ...
  function destroy() {
    ...
    swiper.pagination.$el;
    if (params.clickable) {
      swiper.off("paginationItemClick", uni_modules_zebraSwiper_shared_classesToSelector.classesToSelector(params.bulletClass));
    }
  }
  on("init update", () => {
